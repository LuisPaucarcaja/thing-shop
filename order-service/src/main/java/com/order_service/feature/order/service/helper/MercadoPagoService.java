...
public class MercadoPagoService {
    ...
    private PreferencePaymentMethodsRequest buildPaymentMethods() {
        ...
        List<PreferencePaymentMethodRequest> excludedPaymentMethods = List.of(
                PreferencePaymentMethodRequest.builder().id(MercadoPagoConstants.PAYMENT_METHOD_PAGOEFECTIVO_ATM).build() //Excludes Cash Payment
        );
    ...
    private PreferenceRequest buildPreferenceRequest(Long orderId,
        ...
        return PreferenceRequest.builder()
                ...
                .metadata(Map.of(MercadoPagoConstants.ORDER_ID_FIELD, orderId))
                .expires(true)
