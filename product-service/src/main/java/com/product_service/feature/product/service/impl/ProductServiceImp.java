...
import com.product_service.feature.product.service.recommendation.ProductRecommendationService;
...
public class ProductServiceImp implements IProductService {
    ...
    public PaginatedResponse<ProductPreviewDto> getByCategoryAndBrandAndPriceRange(Long categoryId, Long brandId,
        ...
        Pageable pageable = PageRequest.of(page, GeneralConstants.DEFAULT_PAGE_SIZE);
    ...
    public List<ProductPreviewDto> getRandomProductsByCategory(Long categoryId) {
        ...
        List<Long> randomIds =  productRepository.findRandomProductIdsByCategory(categoryId,
                GeneralConstants.DEFAULT_PRODUCT_LIMIT);
    ...
    public List<ProductSummary> getProductSuggestions(String searchTerm) {
        Page<ProductSummary> productPage = productRepository.findProductSummariesByTerm(searchTerm,
                PageRequest.of(0, GeneralConstants.DEFAULT_PRODUCT_LIMIT));
